...
def main():
    st.set_page_config(page_title="Sprawdź czy przeżyłbys katastrofę Tytanica!")
    overview = st.container()
    left, right = st.columns(2)
    prediction = st.container()

    st.image("https://i.iplsc.com/-/000ABW5TIMK0DSYF-C122.jpg")

    with overview:
        st.title("Sprawdź czy przeżyłbys katastrofę Tytanica!")
